                    ...
                    <form onSubmit={handleCalculate} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" min="0" max="1000" className="w-full px-4 py-2 rounded-xl border border-slate-300 text-slate-900 focus:border-indigo-500 outline-none" value={linguagens} onChange={(e) => setLinguagens(e.target.value)} placeholder="Ex: 700" />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-1">Humanas</label>
                                <input type="number" min="0" max="1000" className="w-full px-4 py-2 rounded-xl border border-slate-300 text-slate-900 focus:border-indigo-500 outline-none" value={humanas} onChange={(e) => setHumanas(e.target.value)} placeholder="Ex: 650" />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-1">Natureza</label>
                                <input type="number" min="0" max="1000" className="w-full px-4 py-2 rounded-xl border border-slate-300 text-slate-900 focus:border-indigo-500 outline-none" value={natureza} onChange={(e) => setNatureza(e.target.value)} placeholder="Ex: 720" />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-1">Matemática</label>
                                <input type="number" min="0" max="1000" className="w-full px-4 py-2 rounded-xl border border-slate-300 text-slate-900 focus:border-indigo-500 outline-none" value={matematica} onChange={(e) => setMatematica(e.target.value)} placeholder="Ex: 810" />
                            </div>
                        </div>
                            ...
                            {showEmailCapture && (
                                <form onSubmit={handleEmailSubmit} className="flex flex-col sm:flex-row gap-2 mt-4">
                                    <input 
                                        type="email" 
                                        required 
                                        className="flex-1 px-4 py-2 rounded-xl border border-slate-300 text-slate-900 focus:border-indigo-500 outline-none" 
